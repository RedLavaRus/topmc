<div id="msg_wie_don"></div>
						<div class="donat_blokc_main" id="showshop1">
						<h3>СЕРВЕР TEHNO</h3>
						<div class="donat_box" id="donat_vip_box">
							<div class="donat_box_head" id="donat_vip_head">МЕХАНИК</div>
							<img src="/img/priv/tehnowar/meh.png"" class="donat_ava_byuX">							
							<a id="shop_act_tehnowar_by_1"><div class="donat_but_buy">Купить</div></a>
							<a id="shop_act_tehnowar_info_1"><div class="donat_but_info">Инфо</div></a>
						</div>
						<div class="donat_box" id="donat_prem_box">
							<div class="donat_box_head" id="donat_prem_head">ИНЖЕНЕР</div>
							<img src="/img/priv/tehnowar/ing.png" class="donat_ava_byuX">
							<a id="shop_act_tehnowar_by_2"><div class="donat_but_buy">Купить</div></a>
							<a id="shop_act_tehnowar_info_2"><div class="donat_but_info">Инфо</div></a>
						</div>
						<div class="donat_box" id="donat_lord_box">
							<div class="donat_box_head" id="donat_lord_head">ИЛОН МАСК</div>
							<img src="/img/priv/tehnowar/ilon.png" class="donat_ava_byuX">
							<a id="shop_act_tehnowar_by_3"><div class="donat_but_buy">Купить</div></a>
							<a id="shop_act_tehnowar_info_3"><div class="donat_but_info">Инфо</div></a>
						</div>
						<div class="donat_box" id="donat_mic_box">
							<div class="donat_box_head" id="donat_mic_head">МЕЦЕНАТ</div>
							<img src="/img/priv/tehnowar/mec.png" class="donat_ava_byuX">
							<a id="shop_act_tehnowar_by_4"><div class="donat_but_buy">Купить</div></a>
							<a id="shop_act_tehnowar_info_4"><div class="donat_but_info">Инфо</div></a>
						</div>
</div>
<script>  
