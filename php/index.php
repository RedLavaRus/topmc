...
$ip = "127.0.0.1"; // IP адрес сервера Minecraft
...
if($online){echo "on";}else{echo "off";}
echo $cur = $Server2->CurPlayers; // количество онлайн игроков на сервере
echo $max = $Server2->MaxPlayers; // максимум игроков на сервере
echo $motd = $Server2->MOTD; // MOTD сервера
